			...
			<div id="msn-window-header-menu" class="cursor-move rounded-md flex justify-between items-center mb-2 bg-gradient-to-b from-blue-gray-300 via-transparent to-transparent">
				<div class="flex cursor-default">
					...
					<span style="max-width: 40px;" class="p-0.5 mr-2">
						<img src="{{ url('/assets/images/logos/msn.svg') }}" />
					</span>
							...
							<label for="cbox1" class="cursor-pointer">
								<span class="flex w-max">
									<div class="flex mr-2 rounded-sm border border-blue-gray-500 bg-gradient-to-b from-blue-gray-50 to-blue-gray-300 text-blue-gray-500">
										<img x-show="!friendsListExpanded" src="{{ url('/assets/images/icons/plus-thick.svg') }}" width="13" />
										<img x-show="friendsListExpanded" src="{{ url('/assets/images/icons/minus-thick.svg') }}" width="13" />
									</div>
